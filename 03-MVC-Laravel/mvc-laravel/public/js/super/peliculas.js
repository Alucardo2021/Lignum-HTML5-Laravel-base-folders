            ...
            $("#tbodyPeliculas").append(
                ...
                <tr>
                    ...
                    <td>${element.Duracion} </td>
                        <td>
                            <button type="button" class="btn btn-info btn-ver-imagen" onclick="verImagenPelicula(${element.PeliculaID})">
                        ...
                        <td>
                            <button type="button" class="btn btn-warning editarBotonPelicula" data-bs-toggle="modal" data-bs-target="#editarModalPelicula" onclick="editarPelicula(${element.PeliculaID})" >
                        ...
                        <td>
                            <button type="button" class="btn btn-danger eliminarBotonPelicula" onclick="borrarPelicula(${element.PeliculaID})">
...
function borrarPelicula($peliculaID){
    Swal.fire({
                    title: 'Esta seguro de querer borrar esta pelicula?',
                    ...
                    if (result.isConfirmed) {
                        borrarPeliculaConfirmada($peliculaID);
                    }
    })
}

function borrarPeliculaConfirmada($peliculaID) {
    $.ajax({
        url: 'peliculas/delete',
        data: {
...
function verImagenPelicula($peliculaID) {
    $.ajax({
        url: 'peliculas/find',
        data: {
            "_token": $('meta[name="csrf-token"]').attr('content'),
...
function editarPelicula($peliculaID) {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#editarPelicula').attr('PeliculaID',$peliculaID);
        },
        error: function (e) {
            console.log(e);
            console.log(2);
...
formData.append('PeliculaID', $('#editarPelicula').attr('PeliculaID'));
