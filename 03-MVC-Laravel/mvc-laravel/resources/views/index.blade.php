...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col align-self-center" style="text-align: end">
                <button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#agregarModal" id="botonAgregarActor">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                        <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                    </svg>
    ...
    <!-- Modal -->
    <div class="modal fade" id="elModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row px-5">
                            ...
                            <input type="date" id="fechaActor" max="<?= date("Y-m-d", strtotime("now")) ?>">
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        ...
        $('body').on('click', '#agregarActor', function (e){
            $.ajax({
                ...
                data: {
                    "_token": "{{ csrf_token() }}",
                    'nombre': $('#nombreActor').val(),
                    'fecha': $('#fechaActor').val(),
                },
                dataType: "json",
                method: "POST",
        ...
        /* $('body').on('click', '#botonAgregarActor', function () {
            $(`#agregarModal`).html('');
            $(`#agregarModal`).append(
                `<div class="modal-dialog" role="document">
                    <div class="modal-content">
